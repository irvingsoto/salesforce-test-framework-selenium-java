...
public class ComponentReferecePage {
    ...
    public WebElement getExampleDrp1 (){ return (new WebDriverWait(driver, 20)).until(ExpectedConditions.elementToBeClickable(By.id("input-365"))); }
    public WebElement getOpenInPlaygroundBtn (){ return (new WebDriverWait(driver, 10)).until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(.,'Open in Playground')]"))); }
