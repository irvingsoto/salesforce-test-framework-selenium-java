...
public class PlayGroundPage {
    ...
    public WebElement getPhoneNumberRow3Txt() { return(new WebDriverWait(driver, 20)).until(ExpectedConditions.presenceOfElementLocated(By.id("input-1940"))); }
    public WebElement getDateRow3Txt() { return(new WebDriverWait(driver, 20)).until(ExpectedConditions.presenceOfElementLocated(By.id("input-1945"))); }
    public WebElement getTimeRow3Txt() { return(new WebDriverWait(driver, 20)).until(ExpectedConditions.presenceOfElementLocated(By.id("input-1949"))); }
    public WebElement getBalanceRow3Txt() { return(new WebDriverWait(driver, 20)).until(ExpectedConditions.presenceOfElementLocated(By.id("input-2049"))); }
    //Shortened Absolute
